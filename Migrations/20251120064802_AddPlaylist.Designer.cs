...
namespace Shopify.Migrations
{
    ...
    [Migration("20251120064802_AddPlaylist")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopify.Models.Playlist", b =>
                {
            ...
            modelBuilder.Entity("Shopify.Models.PlaylistSong", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopify.Models.PlaylistSong", b =>
                {
                    b.HasOne("Shopify.Models.Playlist", "Playlist")
                        .WithMany("PlaylistSongs")
                        .HasForeignKey("PlaylistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shopify.Models.Song", "Song")
                        .WithMany()
